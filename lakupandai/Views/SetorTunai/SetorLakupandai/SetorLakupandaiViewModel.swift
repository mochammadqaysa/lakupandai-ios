//
//  SetorLakupandaiViewModel.swift
//  lakupandai
//
...
class SetorLakupandaiViewModel : ObservableObject {
    ...
    func validateForm() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            if self.nominal.isEmpty || self.noTelpon.isEmpty {
                self.showAlert = true
                ...
                self.setorTunaiLakupandai()
            }
            self.isLoading = false
        }
    }
    
    func setorTunaiLakupandai() {
        ...
        let params: [String: Any] = [
            ...
            ConstantTransaction.MSISDN_NASABAH_SETOR_TUNAI : self.noTelpon,
            ConstantTransaction.NOMINAL_SETOR_TUNAI : self.nominal,
            ConstantTransaction.ACTION : ConstantTransaction.ACTION_SETOR_TUNAI
        ]
        do {
