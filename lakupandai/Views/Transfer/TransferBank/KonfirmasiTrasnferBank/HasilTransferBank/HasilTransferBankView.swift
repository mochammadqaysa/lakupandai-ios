...
struct HasilTransferBankView: View {
...
struct HasilTransferBankView_Previews: PreviewProvider {
    static var previews: some View {
        HasilTransferBankView(dataHasil: [], layanan: "Transfer Dana")
    }
}
