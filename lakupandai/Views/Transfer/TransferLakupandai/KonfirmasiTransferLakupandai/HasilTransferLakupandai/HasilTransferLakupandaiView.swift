//
//  HasilTransferLakupandaiView.swift
//  lakupandai
//
...
struct HasilTransferLakupandaiView: View {
...
struct HasilTransferLakupandaiView_Previews: PreviewProvider {
    static var previews: some View {
        HasilTransferLakupandaiView(dataHasil: [], layanan: "Transfer Dana")
    }
}
