//
//  KonfirmasiTransferBPDViewModel.swift
//  lakupandai
//
...
class KonfirmasiTransferBPDViewModel : ObservableObject {
    ...
    func requestOtp() {
        let requestTarikTunai = UserDefaultsManager.shared.getString(forKey: "temp_body_transfer_bpd")
    ...
    func validateForm() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            if self.otpNasabah.isEmpty {
                ...
                self.konfirmasiTransferBPD()
            }
            self.isLoading = false
        }
    }
    
    func konfirmasiTransferBPD() {
        ...
        let params: [String: Any] = [
            ...
            ConstantTransaction.TOKEN_TRANSFER_KONFIRMASI : self.otpNasabah,
            ConstantTransaction.ACTION : ConstantTransaction.ACTION_TRANSFER_KONFIRMASI
        ]
        do {
